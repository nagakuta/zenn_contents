---
title: "誰かを救う、Docker で Firebase Project の開発環境を構築する方法"
emoji: "🐳"
...
この記事では Docker for Mac を利用して Docker Container を立ち上げ、Firebase Project の開発環境を構築することを目指します。
...
## まとめ
この記事では、Apple Silicon な macOS 上に Docker Container を立ち上げ、Firebase Project の開発環境を構築する方法を紹介しました。
